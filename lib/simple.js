 ...
 * Modificato da:
 * - https://github.com/realzyklon
 * - https://github.com/realzyklon/zyklonbot
*/
...
export function makeWASocket(connectionOptions, options = {}) {
  ...
  const sock = Object.defineProperties(conn, {
    ...
    sendFile: {
       ...
       * @param {import('@realvare/based').proto.WebMessageInfo} quoted
       * @param {Boolean} ptt
...
sendList: {
  ...
  const sections = [...listSections]
    ...
    cMod: {
       ...
       * cMod
       * @param {String} jid
       * @param {import('@realvare/based').proto.WebMessageInfo} message
       * @param {String} text
       * @param {String} sender
       * @param {*} options
       * @returns
    ...
    loadMessage: {
       ...
       * @returns {import('@realvare/based').proto.WebMessageInfo}
       */
      value(messageID) {
    ...
    processMessageStubType: {
       ...
       * @param {import('@realvare/based').proto.WebMessageInfo} m
       */
      async value(m) {
        ...
        for (const message of m) {
          try {
            ...
            if (message.message?.[mtype]?.contextInfo?.quotedMessage) {
              /**
               * @type {import('@realvare/based').proto.IContextInfo}
               */
              const context = message.message[mtype].contextInfo;
              let participant = conn.decodeJid(context.participant);
              const remoteJid = conn.decodeJid(context.remoteJid || participant);
              /**
               * @type {import('@realvare/based').proto.IMessage}
               *
               */
